...
class DataUpload(models.Model):
    ...
    metadata_spreadsheet = models.FileField(upload_to='/var/www/metadata/',validators=[validate_file_extension])
    sapflow_file = models.FileField(upload_to='/var/www/metadata/',null=True,validators=[validate_file_extension_csv])
    sapflow_included = models.BooleanField(default=False)
    envdata_file = models.FileField(upload_to='/var/www/metadata/',null=True,validators=[validate_file_extension_csv])
